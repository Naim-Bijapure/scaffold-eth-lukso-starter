...
export default function User_1(): JSX.Element {
  ...
  useEffect(() => {
    ...
    setUser2Address("0x511dC8Aa8EfAA90Ea05f6adb09fCD394Ed005384");
  ...
  const onGrantMsg: () => any = async (): Promise<any> => {
    ...
    const beneficiaryAddress = user2Address; // EOA address of an exemplary person
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="m-2">
          <div className="form-control">
            ...
            <input type="text" className="mt-2 input input-primary" placeholder="send msg to user 2" />
